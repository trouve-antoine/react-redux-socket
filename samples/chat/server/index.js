...
ioActionHandler(io)
  .handlers(defaultHandlers.authenticate(socketAuth.promiseServerAuthenticate).log(log))
  .handlers(defaultHandlers.joinRoom(socketAuth.serverRoomName).log(log))
  .handlers(defaultHandlers.logConnection(log))
